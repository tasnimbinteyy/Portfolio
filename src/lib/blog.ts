...
export const cgLabPosts: CGLabPost[] = [
  ...
  {
    slug: "cg-lab-8-kmeans-clustering",
    ...
    subtopics: [
      ...
      { id: "algorithm", label: "K-Means Algorithm" },
      { id: "implementation", label: "Implementation" },
      { id: "k-values", label: "Effect of K Values" },
    ],
  },
  {
    slug: "cg-lab-9-edge-detection",
    title: "Lab 9: Edge Detection",
    ...
    labNumber: 9,
    subtopics: [
      { id: "what-is-edge", label: "What is an Edge?" },
      { id: "roberts", label: "Roberts Operator" },
      { id: "prewitt", label: "Prewitt Operator" },
      { id: "sobel", label: "Sobel Operator" },
